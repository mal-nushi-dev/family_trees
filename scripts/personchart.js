...
var canvas;
var context;
var maleBoxColor = '#709FE7';
var lighterMaleBoxColor;
var femaleBoxColor = '#EC8E8B';
...
function initPersonChart() {
    ...
    lighterMaleBoxColor = lighterHexColor(maleBoxColor, 0.375);
    lighterFemaleBoxColor = lighterHexColor(femaleBoxColor, 0.375);
    
    unknownGenderBoxColor = '#DDD';
    lighterUnknownGenderBoxColor = lighterHexColor(unknownGenderBoxColor, 0.375);
